...
export const productosMock: Producto[] = [
  // Bonsáis
  {
    ...
    descripcion: 'El Ficus Retusa es uno de los bonsais más populares para principiantes. Resistente y de fácil cuidado, perfecto para ambientes interiores con buena iluminación. Sus hojas brillantes y su tronco robusto lo convierten en una pieza decorativa excepcional.',
    precio: 49.99,
    ...
    slug: 'ficus-retusa-bonsai-interior',
  ...
  },
  {
    ...
    descripcion: 'La Carmona, también conocida como bonsai del té, presenta pequeñas hojas verdes oscuras y delicadas flores blancas. Perfecta para interior, requiere iluminación abundante y riego regular.',
    precio: 39.99,
    sku: 'BON-CAR-003',
    categoria: 'bonsai',
    ...
    toxicidadMascotas: false,
    variabilidadNatural: true,
    slug: 'carmona-microphylla-bonsai-te',
  ...
  },
  {
    ...
    descripcion: 'El Juniperus Chinensis es un clásico entre los bonsais de exterior. Muy resistente, tolera bien las podas y alambrados. Ideal para crear estilos cascada o informal erecto.',
    precio: 69.99,
    sku: 'BON-JUN-004',
    categoria: 'bonsai',
  ...
  // Accesorios
  {
    ...
    descripcion: 'Kit completo de herramientas esenciales para el cuidado de tu bonsai. Incluye: tijeras de poda, tijeras de defoliación, pinzas, rastrillo y podadora cóncava. Acero inoxidable de alta calidad.',
    precio: 34.99,
    sku: 'ACC-HER-001',
    categoria: 'accesorio',
    ...
    destacado: true,
    nuevo: false,
    slug: 'kit-herramientas-bonsai-5-piezas',
    metaDescripcion: 'Kit completo de 5 herramientas profesionales para bonsai.',
  ...
  },
  {
    ...
    descripcion: 'Sustrato Akadama de calidad premium, importado de Japón. Ideal para bonsais, proporciona excelente drenaje y retención de nutrientes. Granulometría media (4-7mm).',
    precio: 12.99,
    sku: 'ACC-SUS-001',
    categoria: 'accesorio',
    ...
    metaDescripcion: 'Sustrato Akadama japonés premium para bonsai. 2 litros.',
  ...
  },
  {
    ...
    descripcion: 'Maceta de cerámica esmaltada en azul cobalto, fabricada artesanalmente. Incluye rejilla de drenaje y pies. Perfecta para bonsais de tamaño medio (20-30cm).',
    precio: 24.99,
    sku: 'ACC-MAC-001',
    categoria: 'accesorio',
    ...
    metaDescripcion: 'Maceta cerámica esmaltada artesanal para bonsai. 20cm.',
