...
const productosEjemplo: Omit<Producto, 'id'>[] = [
  ...
  },
  {
    ...
    variabilidadNatural: true,
    metaDescripcion: 'Pino Negro Japonés auténtico. Especie tradicional de bonsai para exterior.',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    nombre: 'Kit Herramientas Básicas para Bonsái',
    slug: 'kit-herramientas-basicas-bonsai',
    ...
    metaDescripcion: 'Kit completo de herramientas básicas para bonsai. Acero inoxidable de calidad.',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    metaDescripcion: 'Akadama japonés auténtico. Sustrato premium para bonsai de máxima calidad.',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
];
